...
local AUTLevelUtil = loadstring(game:HttpGet(
    "https://raw.githubusercontent.com/Supreme4ab/SunniHubTest/main/Modules/AUTLevelModule.lua"
))()
...
section:AddDropdown("TeleportLocation", {
    ...
    Callback    = function(choice)
        selectedTeleport = AUTLevelUtil.TeleportLocations[choice]
    end,
})
section:AddButton({
    Title       = "Teleport",
