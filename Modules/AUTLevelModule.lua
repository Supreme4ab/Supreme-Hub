...
-- Shard rarities mapping to ability IDs
local ShardRarities = {
    ...
    Rare      = { "ABILITY_6",  "ABILITY_9",  "ABILITY_50923","ABILITY_350",  "ABILITY_2000","ABILITY_300000",
                  "ABILITY_4",  "ABILITY_2",  "ABILITY_732"                                      },
    Epic      = { "ABILITY_77", "ABILITY_420","ABILITY_80086","ABILITY_73",   "ABILITY_2555","ABILITY_41321",
                  "ABILITY_456073","ABILITY_140404","ABILITY_24","ABILITY_70","ABILITY_19","ABILITY_421",
                  "ABILITY_100000","ABILITY_1300"                                               },
    Legendary = { "ABILITY_5",  "ABILITY_666","ABILITY_20",   "ABILITY_9111",  "ABILITY_684","ABILITY_27",
...
-- Set AllowedAbilities based on a list of rarity names
...
function AUTLevelUtil.BuildSellTable(allowed, shardsPerAbility)
    ...
    for _, abilityId in ipairs(allowedAbilities) do
        ...
        local amount = frame
            and frame:FindFirstChild("Button")
            and tonumber(frame.Button:FindFirstChild("Amount") and frame.Button.Amount.Text)
